...
const Filters = () => {
    ...
    function handleClick(checkbox) {
        if (typeof window !== 'undefined') {
            ...
            //allow only 1 checkbox in the group to be checked
            checkboxes.forEach((item) => {
                if (item !== checkbox) item.checked = false;
            });

            //if unchecked, delete the param from  query or remove it
            ...
            //update filter query param according to what's checked or append if the param doesn't already exist in the url
            else {
                //update
    ...
    return (
        <div className="sidebar mt-5 filters-sidebar">
            <h3>Filters</h3>
            ...
            <div className="form-check">
                <input
                    ...
                    defaultChecked={checkHandler("experience", "3 Years and above")}
                    onClick={(e) => handleClick(e.target)}
                />
            ...
            <div className="form-check">
                <input
                    ...
                    name="mode"
                    id="check15"
                    value="Work from Home/Remote"
                    defaultChecked={checkHandler("mode", "Work from Home/Remote")}
                    onClick={(e) => handleClick(e.target)}
                />
            ...
            <div className="form-check">
                <input
                    ...
                    id="check16"
                    value="Onsite"
                    defaultChecked={checkHandler("mode", "Onsite")}
                    onClick={(e) => handleClick(e.target)}
                />
            ...
            <div className="form-check">
                <input
                    ...
                    id="check17"
                    value="Hybrid Mode"
                    defaultChecked={checkHandler("mode", "Hybrid Mode")}
                    onClick={(e) => handleClick(e.target)}
                />
